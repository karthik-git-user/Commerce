 ...
 */
@Controller
@RequestMapping(value = "/checkout/multi/novalnet/order")
public class NovalnetCheckoutController extends AbstractCheckoutController
{
    ...
    @RequestMapping(value = "/confirmation/" + ORDER_CODE_PATH_VARIABLE_PATTERN, method = RequestMethod.GET)
    @RequireHardLogIn
    ...
    @RequestMapping(value = "/confirmation/" + ORDER_CODE_PATH_VARIABLE_PATTERN, method = RequestMethod.POST)
            ...
            final RedirectAttributes redirectModel) throws CMSItemNotFoundException
    {
        ...
        model.addAttribute("tid", getSessionService().getAttribute("novalnetOrderComments"));
